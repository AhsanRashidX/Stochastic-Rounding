your_project/ ├── gpt_experiment.py # Your main file (modified) ├── quantization_utils.py # NEW: Quantization functions ├── quantized_layers.py # NEW: Custom quantized layers └── train_utils.py # NEW: Training utilities
